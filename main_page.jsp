<%-- 
    Document   : main_page
    Created on : 20 Jan, 2018, 10:42:34 PM
    Author     : Sakshi
--%>
...
<div class="wrapper row3">
    <div class="rounded">
        <center><h1 style="color:orange;font-size:40px">Hi! USer</h1>
            <h3>
                <h3> Customer Name :
         <% out.print((String)request.getAttribute("name")); %></h3>
        <h3> Customer Id :
         <% out.print((String)request.getAttribute("id")); %></h3>
        Your current reading is :
        <% out.print((int)request.getAttribute("reading")); %></h3>
        <h3> Your adharid is :
         <% out.print((String)request.getAttribute("adharid")); %></h3>
       
        <h3>  Your previous reading was:
          <% out.print((int)request.getAttribute("readingOld")); %></h3>
        <h3> Your address is :
         <% out.print((String)request.getAttribute("address")); %></h3>
        <h3> Your city is :
         <% out.print((String)request.getAttribute("city")); %></h3>
            <h3> Your state is :
         <% out.print((String)request.getAttribute("state")); %></h3>
          <h3> Pincode :
         <% out.print((int)request.getAttribute("pincode")); %></h3>
           <h3> Your email id is :
         <% out.print((String)request.getAttribute("email")); %></h3>
         <h3>Current date is :
         <% out.print((String)request.getAttribute("date")); %></h3>
           
            <form action="PayBillServlet" method="post">
                <button  type="submit">Show your current bill till date</button>
