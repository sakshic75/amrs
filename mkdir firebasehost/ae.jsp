<%-- 
    Document   : index
    Created on : 8 Feb, 2018, 11:17:10 AM
    Author     : Sakshi
--%>
<%@page import="Servlets.EmailServlet"%>
<%@page import="Servlets.EmailModel"%>
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
       <center><h1 style="background-color:white;color:black">   <% String alert=(String)request.getAttribute("message");if(alert!=null)
         {out.print((String)request.getAttribute("message"));} %></h1></center>
     <figure id="slide-1"><a class="view" href="#"><img src="images/demo/MP.jpg" style="width:98%;height:400px" alt=""></a>
      ...
      <div class="one_third">
        ...
        <ul class="faico clear">
          ...
          <li><a target="_blank" class="faicon-facebook" href="https://www.facebook.com/PowerMinistryIndia/"><i class="fa fa-facebook"></i></a></li>
                  ...
                  <fieldset>
        <form class="clear" method="post" action="EmailServlet">
        
            <legend>Register your email?
                <br>Enter your email:</legend>
            <h2 style="background-color:lightcoral;color:black">  <% out.print((String)request.getAttribute("email")); %></h2>
              
            
            <input type="text" value="" placeholder="Enter Email Here&hellip;" name="email">
